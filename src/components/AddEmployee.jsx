...
const AddEmployee = (props) => {
    ...
    return (
        <>
            <button className="border-2 border-zinc-600 rounded-md w-[150px] py-2" onClick={props.handleOpen}>
                Add New Member
            </button>
            <Modal
            open={props.open}
            ...
            className='w-[500px] bg-white rounded-lg shadow-xl absolute top-[30%] left-[40%] flex flex-col justify-center items-center gap-3 py-3'> 
                ...
                <Box display="flex" gap={4}>
                    ...
                    <Button variant="contained" onClick={() => props.btnFunction(employee)} >Add</Button>
                </Box>
            </Box>
            </Modal>
        </>
